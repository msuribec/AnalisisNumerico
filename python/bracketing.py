...
#    Nov 14, 2020 09:11:29 PM EST  platform: Windows NT
...
import bracketing_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    bracketing_support.set_Tk_var()
    top = Toplevel1 (root)
    bracketing_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    bracketing_support.set_Tk_var()
    top = Toplevel1 (w)
    bracketing_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.geometry("789x667+271+250")
        top.minsize(148, 1)
        top.maxsize(1924, 1055)
        top.resizable(1,  1)
        top.title("Bracketing methods")
        ...
        self.choiceInteg.place(relx=0.266, rely=0.06, relheight=0.039
                , relwidth=0.376)
        self.value_list = ['bisection','regula falsi',]
        self.choiceInteg.configure(values=self.value_list)
        self.choiceInteg.configure(textvariable=bracketing_support.combobox)
        ...
        self.valueaEntry.place(relx=0.266, rely=0.21, height=24, relwidth=0.385)
        ...
        self.valuebEntry.place(relx=0.266, rely=0.285, height=24, relwidth=0.132)
        ...
        self.Label1.place(relx=0.165, rely=0.135, height=26, width=62)
        ...
        self.Label2.place(relx=0.228, rely=0.21, height=26, width=14)
        ...
        self.Label3.place(relx=0.228, rely=0.285, height=26, width=15)
        ...
        self.runButton.bind('<ButtonRelease-1>', lambda e: bracketing_support.runMethod(self.choiceInteg, self.fEntry,
                               self.valueaEntry,self.valuebEntry, self.iterationsEntry,self.tolEntry,self.Scrolledtext1))

        self.gobackButton = tk.Button(top)
        self.gobackButton.place(relx=0.456, rely=0.87, height=33, width=126)
        ...
        self.iterationsEntry.place(relx=0.266, rely=0.345, height=24
                , relwidth=0.132)
        ...
        self.Label3_1.place(relx=0.063, rely=0.345, height=26, width=145)
        ...
        self.Scrolledtext1.place(relx=0.342, rely=0.51, relheight=0.312
                , relwidth=0.518)
        ...
        self.tolEntry.place(relx=0.266, rely=0.405, height=24, relwidth=0.132)
        ...
        self.Label3_1_1.place(relx=0.063, rely=0.405, height=26, width=145)
